...
(function (Y, K) {
        ...
        p.prototype.htmlUpdateTransform = function () {
          if (this.added) {
            ...
            !d.styledMode &&
              this.shadows &&
              this.shadows.forEach(function (a) {
                y(a, { marginLeft: e + 1, marginTop: p + 1 });
              });
            this.inverted &&
            ...
            if (!1 === m) this.hide();
              ...
              if (this.split && this.allowShared) this.renderSplit(m, d);
                ...
                if (
                  ...
                  (g = this.getLabel()),
                    (b.style.width && !h) ||
                      g.css({ width: this.chart.spacingBox.width + "px" }),
        ...
        e.prototype.applyZones = function () {
          ...
          if (d.length && (e || f) && h && "undefined" !== typeof h.min) {
            ...
            d.forEach(function (d, F) {
              ...
              t = Math.max(p, l);
              h.isXAxis
                ? ((q = { x: n ? t : u, y: 0, width: r, height: k }),
    ...
    function (f, e, l) {
      ...
      l = (function (e) {
        ...
        l.prototype.getGraphPath = function (e, f, h) {
          ...
          var t = e.reversed;
          t && e.reverse();
          (n = { right: 1, center: 2 }[n] || (n && 3)) && t && (n = 4 - n);
  ...
  K(
    ...
    function (f, e, l, C) {
      ...
      f(C.prototype, { singleStacks: !1, drawLegendSymbol: e.drawRectangle });
